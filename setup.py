...
setup(
    name='genenetweaver',
    version='0.1',
    description='Wrapper for genenetweaver',
    long_description=open('README.md').read(),
    author='Matteo Manica, Vignesh Ram Somnath, Roland Mathis',
    author_email='drugilsberg@gmail.com, vigneshram2510@gmail.com, roland.mathis@gmail.com',
